...
const dictionaries: Record<Language, Record<string, string>> = {
  en: {
    ...
    'auth.setupCodeAccess': 'Password link access',
    ...
    'auth.passwordResetDesc': 'Request a password reset link by email, then choose a new password.',
    ...
    'orders.confirmReject': 'Reject this order? The customer will be notified.',
    'orders.confirmCancel': 'Cancel this order? The customer will be notified.',
    ...
    'operations.description':
      'Set whether customers can order, delivery coverage, and regular opening hours.',
    ...
    'operations.preparationTime': 'Preparation time (minutes)',
    'operations.preparationTimeDesc': 'Used in the customer delivery estimate.',
    'operations.busyUntil': 'Busy until',
    'operations.busyUntilDesc': 'Adds a temporary preparation delay without closing the menu.',
    'operations.autoAccept': 'Automatically accept orders',
    'operations.autoAcceptDesc': 'New orders enter preparation and courier dispatch immediately.',
  ...
  sr: {
    ...
    'auth.passwordResetDesc': 'Zatraži link za reset lozinke na email, zatim postavi novu lozinku.',
    ...
    'orders.reject': 'Odbij porudžbinu',
    'orders.cancel': 'Otkaži porudžbinu',
    'orders.confirmReject': 'Odbiti ovu porudžbinu? Kupac će biti obavešten.',
    'orders.confirmCancel': 'Otkazati ovu porudžbinu? Kupac će biti obavešten.',
    ...
    'operations.description':
      'Podesi da li kupci mogu da naručuju, zonu dostave i redovno radno vreme.',
    ...
    'operations.preparationTime': 'Vreme pripreme (minuti)',
    'operations.preparationTimeDesc': 'Koristi se za procenu vremena dostave kupcu.',
    'operations.busyUntil': 'Zauzet do',
    'operations.busyUntilDesc': 'Dodaje privremeno kašnjenje pripreme bez zatvaranja menija.',
    'operations.autoAccept': 'Automatski prihvataj porudžbine',
    'operations.autoAcceptDesc': 'Nove porudžbine odmah prelaze u pripremu i dodelu dostavljača.',
