...
const dictionaries: Record<Language, Record<string, string>> = {
  en: {
    ...
    'restaurant.publicName': 'Voro Restaurant Operations',
    ...
    'orders.courierCanPickUp': 'Courier can pick up on arrival',
    ...
    'operations.kicker': 'Delivery control',
    'operations.title': 'Operations',
    'operations.description': 'Set whether customers can order, delivery coverage, and regular opening hours.',
    'operations.acceptOrders': 'Accept new orders',
    'operations.acceptOrdersDesc': 'Pause orders instantly without hiding your menu.',
    'operations.deliveryRadius': 'Delivery radius',
    'operations.deliveryRadiusDesc': 'Customers outside this zone cannot check out.',
    'operations.openingHours': 'Opening hours',
    'operations.openingHoursDesc': 'Hours are evaluated in Belgrade time.',
    'operations.open': 'Open for orders',
    'operations.closed': 'Closed',
    'operations.openingTime': '{day} opening time',
    'operations.closingTime': '{day} closing time',
    'operations.saving': 'Saving…',
    'operations.save': 'Save delivery settings',
    'operations.activity': 'Activity',
    'operations.unread': '{count} unread updates',
    'operations.emptyActivity': 'New orders and courier updates will appear here.',
    'day.mon': 'Monday',
    'day.tue': 'Tuesday',
    'day.wed': 'Wednesday',
    'day.thu': 'Thursday',
  ...
  sr: {
    ...
    'restaurant.publicName': 'Voro operativa restorana',
    ...
    'orders.courierCanPickUp': 'Dostavljač preuzima kada stigne',
    ...
    'operations.loading': 'Učitavanje operative…',
    'operations.kicker': 'Kontrola dostave',
    'operations.title': 'Operativa',
    'operations.description': 'Podesi da li kupci mogu da naručuju, zonu dostave i redovno radno vreme.',
    'operations.acceptOrders': 'Prihvataj nove porudžbine',
    'operations.acceptOrdersDesc': 'Pauziraj porudžbine odmah, bez skrivanja menija.',
    'operations.deliveryRadius': 'Radijus dostave',
    'operations.deliveryRadiusDesc': 'Kupci van ove zone ne mogu da završe porudžbinu.',
    'operations.openingHours': 'Radno vreme',
    'operations.openingHoursDesc': 'Vreme se računa po vremenskoj zoni Beograda.',
    'operations.open': 'Otvoreno za porudžbine',
    'operations.closed': 'Zatvoreno',
    'operations.openingTime': 'Vreme otvaranja: {day}',
    'operations.closingTime': 'Vreme zatvaranja: {day}',
    'operations.saving': 'Čuvanje…',
    'operations.save': 'Sačuvaj podešavanja dostave',
    'operations.activity': 'Aktivnosti',
    'operations.unread': '{count} nepročitanih ažuriranja',
    'operations.emptyActivity': 'Nove porudžbine i ažuriranja dostavljača će se pojaviti ovde.',
    'day.mon': 'Ponedeljak',
    'day.tue': 'Utorak',
    'day.wed': 'Sreda',
    'day.thu': 'Četvrtak',
