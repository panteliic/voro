  ...
  try {
    await transporter.sendMail({
      ...
      text: [
        ...
        `Jednokratni kod za podešavanje lozinke: ${invite.setupCode}`,
        '',
      ...
      html: `
        <div style="max-width:560px;margin:0 auto;font-family:Arial,sans-serif;color:#241813;line-height:1.5">
          ...
          <p>Ako otvarate aplikaciju ručno, unesite ovaj jednokratni kod:</p>
          <p style="margin:16px 0;padding:14px;border-radius:8px;background:#fff2ed;color:#c53c1c;font-size:28px;font-weight:700;letter-spacing:5px;text-align:center">${escapeHtml(invite.setupCode)}</p>
