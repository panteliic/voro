...
const sessionManagementLimit = rateLimit({ namespace: 'auth-sessions', limit: 20, windowSeconds: 10 * 60 })
...
authRoutes.post('/sessions', authenticate, sessionManagementLimit, authController.listSessions)
authRoutes.post('/sessions/revoke-others', authenticate, sessionManagementLimit, authController.revokeOtherSessions)
authRoutes.post('/sessions/:sessionId/revoke', authenticate, sessionManagementLimit, authController.revokeSession)
